...
AllWize - Module Firmware Update

Updates the firmware in the RC1701HP radio module

TODO: wiring

Based on the CCLib library by Ioannis Charalampidis
https://github.com/wavesoft/CCLib

Copyright (C) 2014 by Ioannis Charalampidis - Licensed under GNU/GPLv3 License.
Copyright (C) 2015 by Simon Schulz - github.com/fishpepper
...
void setup() {
  ...
  // Create debugger
  dbg = new CCDebugger( RESET_PIN, DC_PIN, DD_PIN_IN, DD_PIN_OUT );
  dbg->setLED( LED_BUILTIN, LED_BUILTIN );
